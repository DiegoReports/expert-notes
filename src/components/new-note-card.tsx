...
export function NewNoteCard({ onNoteCreated }: NewNoteCardProps) {
  ...
  function handleStartRecording() {
    ...
    speechRecognition.maxAlternatives = 1 // Retorna apenas 1 alternativa p/palavras dificeis
    speechRecognition.interimResults = true // Traz resultado a medida que é pronunciado
